...
mydata <- read.csv("~/coding/482/project/Actors/actor_award_data_formatted.csv", header = TRUE, sep = ",", quote = "\"",
...
write.csv(data.frame(Name, pred.probs, OscarWon, Year), file = "~/coding/482/project/Actors/probs_of_winning.csv")
